...
import { LyricsBase, LyricsCreate, LyricsUpdate, POV, Tense, HookStrategy, Lyrics } from '@/types/api/entities';
import { ChipSelector } from '@meatymusic/ui';
import { CollapsibleSectionEditor, LyricSection } from './common/CollapsibleSectionEditor';
...
export interface LyricsEditorEnhancedProps {
  songId?: string;
  initialValue?: Partial<LyricsBase>;
  onSave: (lyrics: LyricsCreate | LyricsUpdate) => void;
  onCancel: () => void;
  className?: string;
...
export function LyricsEditorEnhanced({
  songId,
  initialValue = {},
  onSave,
  onCancel,
  ...
  const handleSave = () => {
    ...
    const saveData: LyricsCreate | LyricsUpdate = {
      ...formData,
      song_id: songId,
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4 rounded border-border-default text-primary focus:ring-2 focus:ring-primary"
            />
            <label
